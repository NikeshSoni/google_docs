...
import { LEFT_MARGIN_DEFAULT , RIGHT_MARGIN_DEFAULT } from "@/constant/margin"

const markar = Array.from({ length: 83 }, (_, i) => i)
                ...
                >
                  {marker % 10 === 0 && (
                    <>
                      ...
                      <span className='absolute bottom-2 test-[10px] text-neutral-500 transform -translate-x-1/2'>
                        {marker / 10 + 1}
                      </span>
                    </>
                  )}
